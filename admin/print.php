...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									{
										$type_of_meal=$type_of_bed * 0.2;
									}else if($meal=="Half Board")
									{
										$type_of_meal=$type_of_bed * 0.3;
									
									}else if($meal=="Full Board")
									{
										$type_of_meal=$type_of_bed * 0.4;
									}
	...
	?>
		<header>
			...
			<address >
				<p>KAYUNGA HOTEL,</p>
				<p>KAYUNGA DISTRICT,<br>Centrol town,<br>street o.</p>
				<p></p>
			</address>
			<span><img alt="" src="assets/img/"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@khotel.com || Web :- www.khotel.com || Phone :- +256 759 66 55 55 </p>
			</div>
		</aside>
	</body>
</html>
